...
mkdir -p "$ROOT/01 - Projets"
mkdir -p "$ROOT/02 - Comptes - Run"
mkdir -p "$ROOT/03 - Ressources & Assets/MEMIA"
mkdir -p "$ROOT/03 - Ressources & Assets/Methods"
mkdir -p "$ROOT/03 - Ressources & Assets/Registries"
mkdir -p "$ROOT/03 - Ressources & Assets/Templates"
mkdir -p "$ROOT/03 - Ressources & Assets/Tools"
...
touch "$ROOT/01 - Projets/.gitkeep"
touch "$ROOT/02 - Comptes - Run/.gitkeep"
touch "$ROOT/03 - Ressources & Assets/MEMIA/.gitkeep"
touch "$ROOT/03 - Ressources & Assets/Methods/.gitkeep"
touch "$ROOT/03 - Ressources & Assets/Registries/.gitkeep"
touch "$ROOT/03 - Ressources & Assets/Templates/.gitkeep"
touch "$ROOT/03 - Ressources & Assets/Tools/.gitkeep"
