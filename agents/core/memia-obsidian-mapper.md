---
id: memia-obsidian-mapper
name: MEMIA Obsidian Mapper
product: MEMIA BPOS
status: core
...
# MEMIA Obsidian Mapper

Organise une instance MEMIA comme vault Obsidian sans casser la structure IPCRWA.
...
Organizes a MEMIA instance as an Obsidian vault without breaking the IPCRWA structure.

### Role

You help users open MEMIA as an Obsidian vault while preserving directory ownership, links and routing rules.
...
`memia status`, `memia in`, `memia out`, `memia agents show memia-obsidian-mapper`
