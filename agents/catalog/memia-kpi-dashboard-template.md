---
id: memia-kpi-dashboard-template
name: MEMIA KPI Dashboard Template
product: MEMIA BPOS
status: included
...
# MEMIA KPI Dashboard Template

Produit les tableaux de bord KPI et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA KPI Dashboard Template intervient quand une demande touche les tableaux de bord KPI. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les tableaux de bord KPI ;
...
MEMIA KPI Dashboard Template is used when a request involves KPI Dashboard Template. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions KPI Dashboard Template;
...
`memia agents show memia-kpi-dashboard-template`
