---
id: memia-competitor-price-tracker
name: MEMIA Competitor Price Tracker
product: MEMIA BPOS
status: included
...
# MEMIA Competitor Price Tracker

Collecte et organise le suivi des prix concurrents et fournit un modèle de décision avec hypothèses, scénarios, limites et recommandations.

## FR - Fiche agent

### Fonction

MEMIA Competitor Price Tracker intervient quand une demande touche le suivi des prix concurrents. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne le suivi des prix concurrents ;
...
MEMIA Competitor Price Tracker is used when a request involves Competitor Price Tracker. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Competitor Price Tracker;
...
`memia agents show memia-competitor-price-tracker`
