---
id: memia-asana-task-creator
name: MEMIA Asana Task Creator
product: MEMIA BPOS
status: included
...
# MEMIA Asana Task Creator

Produit les tâches opérationnelles et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Asana Task Creator intervient quand une demande touche les tâches opérationnelles. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les tâches opérationnelles ;
...
MEMIA Asana Task Creator is used when a request involves Asana Task Creator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Asana Task Creator;
...
`memia agents show memia-asana-task-creator`
