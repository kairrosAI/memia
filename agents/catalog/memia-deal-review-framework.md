---
id: memia-deal-review-framework
name: MEMIA Deal Review Framework
product: MEMIA BPOS
status: included
...
# MEMIA Deal Review Framework

Aide à cadrer les revues d’opportunités et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Deal Review Framework intervient quand une demande touche les revues d’opportunités. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les revues d’opportunités ;
...
MEMIA Deal Review Framework is used when a request involves Deal Review Framework. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Deal Review Framework;
...
`memia agents show memia-deal-review-framework`
