---
id: memia-prompt-engineer
name: MEMIA Prompt Engineer
product: MEMIA BPOS
status: included
...
# MEMIA Prompt Engineer

Aide à cadrer les prompts opérationnels et fournit une proposition technique avec structure, contraintes, tests, risques et critères de validation.

## FR - Fiche agent

### Fonction

MEMIA Prompt Engineer intervient quand une demande touche les prompts opérationnels. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les prompts opérationnels ;
...
MEMIA Prompt Engineer is used when a request involves Prompt Engineer. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Prompt Engineer;
...
`memia agents show memia-prompt-engineer`
