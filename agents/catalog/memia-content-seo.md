---
id: memia-content-seo
name: MEMIA Content SEO
product: MEMIA BPOS
status: included
...
Rédige le SEO de contenu et fournit une analyse vérifiable avec sources, métriques, hypothèses, limites et recommandations.

## FR - Fiche agent

### Fonction

MEMIA Content SEO intervient quand une demande touche le SEO de contenu. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne le SEO de contenu ;
...
MEMIA Content SEO is used when a request involves Content SEO. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Content SEO;
...
`memia agents show memia-content-seo`
