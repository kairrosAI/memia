---
id: memia-nestjs-module-generator
name: MEMIA NestJS Module Generator
product: MEMIA BPOS
status: included
...
# MEMIA NestJS Module Generator

Produit les modules NestJS et fournit une proposition technique avec structure, contraintes, tests, risques et critères de validation.

## FR - Fiche agent

### Fonction

MEMIA NestJS Module Generator intervient quand une demande touche les modules NestJS. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les modules NestJS ;
...
MEMIA NestJS Module Generator is used when a request involves NestJS Module Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions NestJS Module Generator;
...
`memia agents show memia-nestjs-module-generator`
