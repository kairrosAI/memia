---
id: memia-pricing-strategy
name: MEMIA Pricing Strategy
product: MEMIA BPOS
status: included
...
# MEMIA Pricing Strategy

Aide à cadrer la stratégie de prix et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Pricing Strategy intervient quand une demande touche la stratégie de prix. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la stratégie de prix ;
...
MEMIA Pricing Strategy is used when a request involves Pricing Strategy. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Pricing Strategy;
...
`memia agents show memia-pricing-strategy`
