---
id: memia-design-doc-template
name: MEMIA Design Doc Template
product: MEMIA BPOS
status: included
...
# MEMIA Design Doc Template

Produit les design docs et fournit une documentation claire avec public cible, structure, exemples et maintenance prévue.

## FR - Fiche agent

### Fonction

MEMIA Design Doc Template intervient quand une demande touche les design docs. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les design docs ;
...
MEMIA Design Doc Template is used when a request involves Design Doc Template. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Design Doc Template;
...
`memia agents show memia-design-doc-template`
