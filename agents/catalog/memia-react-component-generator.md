---
id: memia-react-component-generator
name: MEMIA React Component Generator
product: MEMIA BPOS
status: included
...
# MEMIA React Component Generator

Produit les composants React et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA React Component Generator intervient quand une demande touche les composants React. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les composants React ;
...
MEMIA React Component Generator is used when a request involves React Component Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions React Component Generator;
...
`memia agents show memia-react-component-generator`
