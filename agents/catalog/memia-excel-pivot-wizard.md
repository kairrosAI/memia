---
id: memia-excel-pivot-wizard
name: MEMIA Excel Pivot Wizard
product: MEMIA BPOS
status: included
...
# MEMIA Excel Pivot Wizard

Aide à cadrer les tableaux croisés Excel et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Excel Pivot Wizard intervient quand une demande touche les tableaux croisés Excel. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les tableaux croisés Excel ;
...
MEMIA Excel Pivot Wizard is used when a request involves Excel Pivot Wizard. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Excel Pivot Wizard;
...
`memia agents show memia-excel-pivot-wizard`
