---
id: memia-draft-writer
name: MEMIA Draft Writer
product: MEMIA BPOS
status: included
...
Rédige les brouillons éditoriaux et fournit un dossier d’exécution avec contexte technique, options, points de vigilance et suite concrète.

## FR - Fiche agent

### Fonction

MEMIA Draft Writer intervient quand une demande touche les brouillons éditoriaux. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les brouillons éditoriaux ;
...
MEMIA Draft Writer is used when a request involves Draft Writer. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Draft Writer;
...
`memia agents show memia-draft-writer`
