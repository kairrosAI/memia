---
id: memia-definition-of-done-generator
name: MEMIA Definition of Done Generator
product: MEMIA BPOS
status: included
...
# MEMIA Definition of Done Generator

Produit les définitions de terminé et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Definition of Done Generator intervient quand une demande touche les définitions de terminé. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les définitions de terminé ;
...
MEMIA Definition of Done Generator is used when a request involves Definition of Done Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Definition of Done Generator;
...
`memia agents show memia-definition-of-done-generator`
