---
id: memia-thought-partner
name: MEMIA Thought Partner
product: MEMIA BPOS
status: included
...
# MEMIA Thought Partner

Aide à cadrer la réflexion structurée et fournit une synthèse actionnable avec priorités, arbitrages, risques et prochaines actions.

## FR - Fiche agent

### Fonction

MEMIA Thought Partner intervient quand une demande touche la réflexion structurée. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la réflexion structurée ;
...
MEMIA Thought Partner is used when a request involves Thought Partner. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Thought Partner;
...
`memia agents show memia-thought-partner`
