---
id: memia-portfolio-manager
name: MEMIA Portfolio Manager
product: MEMIA BPOS
status: included
...
# MEMIA Portfolio Manager

Structure la gestion de portefeuille et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Portfolio Manager intervient quand une demande touche la gestion de portefeuille. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la gestion de portefeuille ;
...
MEMIA Portfolio Manager is used when a request involves Portfolio Manager. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Portfolio Manager;
...
`memia agents show memia-portfolio-manager`
