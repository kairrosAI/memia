---
id: memia-data-catalog-updater
name: MEMIA Data Catalog Updater
product: MEMIA BPOS
status: included
...
# MEMIA Data Catalog Updater

Aide à cadrer les catalogues de données et fournit une analyse vérifiable avec sources, métriques, hypothèses, limites et recommandations.

## FR - Fiche agent

### Fonction

MEMIA Data Catalog Updater intervient quand une demande touche les catalogues de données. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les catalogues de données ;
...
MEMIA Data Catalog Updater is used when a request involves Data Catalog Updater. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Data Catalog Updater;
...
`memia agents show memia-data-catalog-updater`
