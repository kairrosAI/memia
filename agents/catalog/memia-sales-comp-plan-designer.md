---
id: memia-sales-comp-plan-designer
name: MEMIA Sales Comp Plan Designer
product: MEMIA BPOS
status: included
...
# MEMIA Sales Comp Plan Designer

Produit les plans de rémunération commerciale et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Sales Comp Plan Designer intervient quand une demande touche les plans de rémunération commerciale. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les plans de rémunération commerciale ;
...
MEMIA Sales Comp Plan Designer is used when a request involves Sales Comp Plan Designer. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Sales Comp Plan Designer;
...
`memia agents show memia-sales-comp-plan-designer`
