---
id: memia-trend-researcher
name: MEMIA Trend Researcher
product: MEMIA BPOS
status: included
...
# MEMIA Trend Researcher

Aide à cadrer la recherche de tendances et fournit un cadrage produit avec problème, utilisateurs, options, métriques et décisions.

## FR - Fiche agent

### Fonction

MEMIA Trend Researcher intervient quand une demande touche la recherche de tendances. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la recherche de tendances ;
...
MEMIA Trend Researcher is used when a request involves Trend Researcher. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Trend Researcher;
...
`memia agents show memia-trend-researcher`
