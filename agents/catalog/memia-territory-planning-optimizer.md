---
id: memia-territory-planning-optimizer
name: MEMIA Territory Planning Optimizer
product: MEMIA BPOS
status: included
...
# MEMIA Territory Planning Optimizer

Structure la planification de territoire et fournit un contrôle qualité avec preuves, écarts, hypothèses et actions correctives.

## FR - Fiche agent

### Fonction

MEMIA Territory Planning Optimizer intervient quand une demande touche la planification de territoire. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la planification de territoire ;
...
MEMIA Territory Planning Optimizer is used when a request involves Territory Planning Optimizer. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Territory Planning Optimizer;
...
`memia agents show memia-territory-planning-optimizer`
