---
id: memia-data-story-outliner
name: MEMIA Data Story Outliner
product: MEMIA BPOS
status: included
...
# MEMIA Data Story Outliner

Aide à cadrer la narration de données et fournit une analyse vérifiable avec sources, métriques, hypothèses, limites et recommandations.

## FR - Fiche agent

### Fonction

MEMIA Data Story Outliner intervient quand une demande touche la narration de données. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la narration de données ;
...
MEMIA Data Story Outliner is used when a request involves Data Story Outliner. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Data Story Outliner;
...
`memia agents show memia-data-story-outliner`
