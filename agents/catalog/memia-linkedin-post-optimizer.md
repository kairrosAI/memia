---
id: memia-linkedin-post-optimizer
name: MEMIA LinkedIn Post Optimizer
product: MEMIA BPOS
status: included
...
# MEMIA LinkedIn Post Optimizer

Structure les posts LinkedIn et fournit un plan de contenu ou d’activation avec audience, message, canaux, variantes et mesure.

## FR - Fiche agent

### Fonction

MEMIA LinkedIn Post Optimizer intervient quand une demande touche les posts LinkedIn. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les posts LinkedIn ;
...
MEMIA LinkedIn Post Optimizer is used when a request involves LinkedIn Post Optimizer. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions LinkedIn Post Optimizer;
...
`memia agents show memia-linkedin-post-optimizer`
