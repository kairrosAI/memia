---
id: memia-ai-citation-strategist
name: MEMIA AI Citation Strategist
product: MEMIA BPOS
status: included
...
# MEMIA AI Citation Strategist

Structure la présence dans les réponses IA et fournit un plan de contenu ou d’activation avec audience, message, canaux, variantes et mesure.

## FR - Fiche agent

### Fonction

MEMIA AI Citation Strategist intervient quand une demande touche la présence dans les réponses IA. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la présence dans les réponses IA ;
...
MEMIA AI Citation Strategist is used when a request involves AI Citation Strategist. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions AI Citation Strategist;
...
`memia agents show memia-ai-citation-strategist`
