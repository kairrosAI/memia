---
id: memia-legal-risks
name: MEMIA Legal Risks
product: MEMIA BPOS
status: included
...
Aide à cadrer les risques juridiques et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Legal Risks intervient quand une demande touche les risques juridiques. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les risques juridiques ;
...
MEMIA Legal Risks is used when a request involves Legal Risks. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Legal Risks;
...
`memia agents show memia-legal-risks`
