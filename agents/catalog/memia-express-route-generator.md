---
id: memia-express-route-generator
name: MEMIA Express Route Generator
product: MEMIA BPOS
status: included
...
# MEMIA Express Route Generator

Produit les routes Express et fournit une proposition technique avec structure, contraintes, tests, risques et critères de validation.

## FR - Fiche agent

### Fonction

MEMIA Express Route Generator intervient quand une demande touche les routes Express. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les routes Express ;
...
MEMIA Express Route Generator is used when a request involves Express Route Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Express Route Generator;
...
`memia agents show memia-express-route-generator`
