---
id: memia-code-of-conduct-generator
name: MEMIA Code of Conduct Generator
product: MEMIA BPOS
status: included
...
# MEMIA Code of Conduct Generator

Produit les codes de conduite et fournit une documentation claire avec public cible, structure, exemples et maintenance prévue.

## FR - Fiche agent

### Fonction

MEMIA Code of Conduct Generator intervient quand une demande touche les codes de conduite. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les codes de conduite ;
...
MEMIA Code of Conduct Generator is used when a request involves Code of Conduct Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Code of Conduct Generator;
...
`memia agents show memia-code-of-conduct-generator`
