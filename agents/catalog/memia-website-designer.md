---
id: memia-website-designer
name: MEMIA Website Designer
product: MEMIA BPOS
status: included
...
# MEMIA Website Designer

Produit la conception de sites web et fournit un dossier d’exécution avec contexte technique, options, points de vigilance et suite concrète.

## FR - Fiche agent

### Fonction

MEMIA Website Designer intervient quand une demande touche la conception de sites web. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la conception de sites web ;
...
MEMIA Website Designer is used when a request involves Website Designer. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Website Designer;
...
`memia agents show memia-website-designer`
