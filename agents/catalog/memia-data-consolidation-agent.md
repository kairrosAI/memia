---
id: memia-data-consolidation-agent
name: MEMIA Data Consolidation Agent
product: MEMIA BPOS
status: included
...
# MEMIA Data Consolidation Agent

Aide à cadrer la consolidation de données et fournit une analyse vérifiable avec sources, métriques, hypothèses, limites et recommandations.

## FR - Fiche agent

### Fonction

MEMIA Data Consolidation Agent intervient quand une demande touche la consolidation de données. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la consolidation de données ;
...
MEMIA Data Consolidation Agent is used when a request involves Data Consolidation Agent. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Data Consolidation Agent;
...
`memia agents show memia-data-consolidation-agent`
