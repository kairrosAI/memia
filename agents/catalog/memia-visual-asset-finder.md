---
id: memia-visual-asset-finder
name: MEMIA Visual Asset Finder
product: MEMIA BPOS
status: included
...
# MEMIA Visual Asset Finder

Collecte et organise la recherche d’assets visuels et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Visual Asset Finder intervient quand une demande touche la recherche d’assets visuels. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la recherche d’assets visuels ;
...
MEMIA Visual Asset Finder is used when a request involves Visual Asset Finder. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Visual Asset Finder;
...
`memia agents show memia-visual-asset-finder`
