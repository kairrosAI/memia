---
id: memia-sales-call-prep-assistant
name: MEMIA Sales Call Prep Assistant
product: MEMIA BPOS
status: included
...
# MEMIA Sales Call Prep Assistant

Aide à cadrer la préparation d’appels commerciaux et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Sales Call Prep Assistant intervient quand une demande touche la préparation d’appels commerciaux. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la préparation d’appels commerciaux ;
...
MEMIA Sales Call Prep Assistant is used when a request involves Sales Call Prep Assistant. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Sales Call Prep Assistant;
...
`memia agents show memia-sales-call-prep-assistant`
