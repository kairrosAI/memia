---
id: memia-webinar-to-content-multiplier
name: MEMIA Webinar to Content Multiplier
product: MEMIA BPOS
status: included
...
# MEMIA Webinar to Content Multiplier

Rédige la déclinaison de webinaires et fournit un plan de contenu ou d’activation avec audience, message, canaux, variantes et mesure.

## FR - Fiche agent

### Fonction

MEMIA Webinar to Content Multiplier intervient quand une demande touche la déclinaison de webinaires. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la déclinaison de webinaires ;
...
MEMIA Webinar to Content Multiplier is used when a request involves Webinar to Content Multiplier. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Webinar to Content Multiplier;
...
`memia agents show memia-webinar-to-content-multiplier`
