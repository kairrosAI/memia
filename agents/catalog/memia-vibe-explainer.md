---
id: memia-vibe-explainer
name: MEMIA Product Vibe Explainer
product: MEMIA BPOS
status: included
...
# MEMIA Product Vibe Explainer

Aide à cadrer l’explication d’un produit et fournit une synthèse actionnable avec priorités, arbitrages, risques et prochaines actions.

## FR - Fiche agent

### Fonction

MEMIA Product Vibe Explainer intervient quand une demande touche l’explication d’un produit. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne l’explication d’un produit ;
...
MEMIA Product Vibe Explainer is used when a request involves product vibe Explainer. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions product vibe Explainer;
...
`memia agents show memia-vibe-explainer`
