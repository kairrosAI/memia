---
id: memia-travel-planner
name: MEMIA Travel Planner
product: MEMIA BPOS
status: included
...
# MEMIA Travel Planner

Structure la planification de voyage et fournit une synthèse actionnable avec priorités, arbitrages, risques et prochaines actions.

## FR - Fiche agent

### Fonction

MEMIA Travel Planner intervient quand une demande touche la planification de voyage. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la planification de voyage ;
...
MEMIA Travel Planner is used when a request involves Travel Planner. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Travel Planner;
...
`memia agents show memia-travel-planner`
