---
id: memia-cowork-deal-room
name: MEMIA Cowork Deal Room
product: MEMIA BPOS
status: included
...
# MEMIA Cowork Deal Room

Aide à cadrer la structuration d’une deal room et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Cowork Deal Room intervient quand une demande touche la structuration d’une deal room. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la structuration d’une deal room ;
...
MEMIA Cowork Deal Room is used when a request involves Cowork Deal Room. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Cowork Deal Room;
...
`memia agents show memia-cowork-deal-room`
