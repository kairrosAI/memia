---
id: memia-product-brief
name: MEMIA Product Brief
product: MEMIA BPOS
status: included
...
Aide à cadrer les briefs produit et fournit une synthèse actionnable avec priorités, arbitrages, risques et prochaines actions.

## FR - Fiche agent

### Fonction

MEMIA Product Brief intervient quand une demande touche les briefs produit. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les briefs produit ;
...
MEMIA Product Brief is used when a request involves Product Brief. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Product Brief;
...
`memia agents show memia-product-brief`
