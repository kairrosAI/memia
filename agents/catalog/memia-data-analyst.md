---
id: memia-data-analyst
name: MEMIA Data Analyst
product: MEMIA BPOS
status: included
...
Aide à cadrer l’analyse de données et fournit une synthèse actionnable avec priorités, arbitrages, risques et prochaines actions.

## FR - Fiche agent

### Fonction

MEMIA Data Analyst intervient quand une demande touche l’analyse de données. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne l’analyse de données ;
...
MEMIA Data Analyst is used when a request involves Data Analyst. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Data Analyst;
...
`memia agents show memia-data-analyst`
