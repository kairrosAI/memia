---
id: memia-local-expert
name: MEMIA Local Knowledge Expert
product: MEMIA BPOS
status: included
...
# MEMIA Local Knowledge Expert

Aide à cadrer la connaissance locale et fournit une synthèse actionnable avec priorités, arbitrages, risques et prochaines actions.

## FR - Fiche agent

### Fonction

MEMIA Local Knowledge Expert intervient quand une demande touche la connaissance locale. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la connaissance locale ;
...
MEMIA Local Knowledge Expert is used when a request involves Local Knowledge Expert. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Local Knowledge Expert;
...
`memia agents show memia-local-expert`
