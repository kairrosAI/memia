---
id: memia-change-request-generator
name: MEMIA Change Request Generator
product: MEMIA BPOS
status: included
...
# MEMIA Change Request Generator

Produit les demandes de changement et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Change Request Generator intervient quand une demande touche les demandes de changement. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les demandes de changement ;
...
MEMIA Change Request Generator is used when a request involves Change Request Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Change Request Generator;
...
`memia agents show memia-change-request-generator`
