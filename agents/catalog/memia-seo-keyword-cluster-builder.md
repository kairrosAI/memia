---
id: memia-seo-keyword-cluster-builder
name: MEMIA SEO Keyword Cluster Builder
product: MEMIA BPOS
status: included
...
# MEMIA SEO Keyword Cluster Builder

Produit les clusters de mots-clés SEO et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA SEO Keyword Cluster Builder intervient quand une demande touche les clusters de mots-clés SEO. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les clusters de mots-clés SEO ;
...
MEMIA SEO Keyword Cluster Builder is used when a request involves SEO Keyword Cluster Builder. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions SEO Keyword Cluster Builder;
...
`memia agents show memia-seo-keyword-cluster-builder`
