---
id: memia-brand-voice-analyzer
name: MEMIA Brand Voice Analyzer
product: MEMIA BPOS
status: included
...
# MEMIA Brand Voice Analyzer

Analyse la voix de marque et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Brand Voice Analyzer intervient quand une demande touche la voix de marque. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la voix de marque ;
...
MEMIA Brand Voice Analyzer is used when a request involves Brand Voice Analyzer. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Brand Voice Analyzer;
...
`memia agents show memia-brand-voice-analyzer`
