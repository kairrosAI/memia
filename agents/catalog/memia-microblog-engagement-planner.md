---
id: memia-microblog-engagement-planner
name: MEMIA Microblog Engagement Planner
product: MEMIA BPOS
status: included
...
# MEMIA Microblog Engagement Planner

Structure l’engagement microblog et fournit un plan de contenu ou d’activation avec audience, message, canaux, variantes et mesure.

## FR - Fiche agent

### Fonction

MEMIA Microblog Engagement Planner intervient quand une demande touche l’engagement microblog. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne l’engagement microblog ;
...
MEMIA Microblog Engagement Planner is used when a request involves Microblog Engagement Planner. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Microblog Engagement Planner;
...
`memia agents show memia-microblog-engagement-planner`
