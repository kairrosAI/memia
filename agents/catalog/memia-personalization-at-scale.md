---
id: memia-personalization-at-scale
name: MEMIA Personalization At Scale
product: MEMIA BPOS
status: included
...
# MEMIA Personalization At Scale

Aide à cadrer la personnalisation à grande échelle et fournit un plan commercial avec signaux, messages, objections, relances et critères de passage.

## FR - Fiche agent

### Fonction

MEMIA Personalization At Scale intervient quand une demande touche la personnalisation à grande échelle. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la personnalisation à grande échelle ;
...
MEMIA Personalization At Scale is used when a request involves Personalization At Scale. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Personalization At Scale;
...
`memia agents show memia-personalization-at-scale`
