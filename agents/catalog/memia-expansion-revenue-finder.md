---
id: memia-expansion-revenue-finder
name: MEMIA Expansion Revenue Finder
product: MEMIA BPOS
status: included
...
# MEMIA Expansion Revenue Finder

Collecte et organise les opportunités d’expansion et fournit un plan de contenu ou d’activation avec audience, message, canaux, variantes et mesure.

## FR - Fiche agent

### Fonction

MEMIA Expansion Revenue Finder intervient quand une demande touche les opportunités d’expansion. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les opportunités d’expansion ;
...
MEMIA Expansion Revenue Finder is used when a request involves Expansion Revenue Finder. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Expansion Revenue Finder;
...
`memia agents show memia-expansion-revenue-finder`
