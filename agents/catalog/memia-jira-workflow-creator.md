---
id: memia-jira-workflow-creator
name: MEMIA Jira Workflow Creator
product: MEMIA BPOS
status: included
...
# MEMIA Jira Workflow Creator

Produit les workflows de suivi et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Jira Workflow Creator intervient quand une demande touche les workflows de suivi. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les workflows de suivi ;
...
MEMIA Jira Workflow Creator is used when a request involves Jira Workflow Creator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Jira Workflow Creator;
...
`memia agents show memia-jira-workflow-creator`
