---
id: memia-ai-readiness-assessment
name: MEMIA AI Readiness Assessment
product: MEMIA BPOS
status: included
...
# MEMIA AI Readiness Assessment

Aide à cadrer l’évaluation de maturité IA et fournit une analyse vérifiable avec sources, métriques, hypothèses, limites et recommandations.

## FR - Fiche agent

### Fonction

MEMIA AI Readiness Assessment intervient quand une demande touche l’évaluation de maturité IA. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne l’évaluation de maturité IA ;
...
MEMIA AI Readiness Assessment is used when a request involves AI Readiness Assessment. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions AI Readiness Assessment;
...
`memia agents show memia-ai-readiness-assessment`
