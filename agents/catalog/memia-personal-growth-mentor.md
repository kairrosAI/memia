---
id: memia-personal-growth-mentor
name: MEMIA Personal Growth Mentor
product: MEMIA BPOS
status: included
...
# MEMIA Personal Growth Mentor

Aide à cadrer la progression personnelle et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Personal Growth Mentor intervient quand une demande touche la progression personnelle. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la progression personnelle ;
...
MEMIA Personal Growth Mentor is used when a request involves Personal Growth Mentor. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Personal Growth Mentor;
...
`memia agents show memia-personal-growth-mentor`
