---
id: memia-budget-calculator
name: MEMIA Budget Calculator
product: MEMIA BPOS
status: included
...
# MEMIA Budget Calculator

Aide à cadrer les budgets et fournit une synthèse actionnable avec priorités, arbitrages, risques et prochaines actions.

## FR - Fiche agent

### Fonction

MEMIA Budget Calculator intervient quand une demande touche les budgets. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les budgets ;
...
MEMIA Budget Calculator is used when a request involves Budget Calculator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Budget Calculator;
...
`memia agents show memia-budget-calculator`
