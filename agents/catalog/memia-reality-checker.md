---
id: memia-reality-checker
name: MEMIA Reality Checker
product: MEMIA BPOS
status: included
...
# MEMIA Reality Checker

Analyse la vérification de réalité et fournit un contrôle qualité avec preuves, écarts, hypothèses et actions correctives.

## FR - Fiche agent

### Fonction

MEMIA Reality Checker intervient quand une demande touche la vérification de réalité. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la vérification de réalité ;
...
MEMIA Reality Checker is used when a request involves Reality Checker. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Reality Checker;
...
`memia agents show memia-reality-checker`
