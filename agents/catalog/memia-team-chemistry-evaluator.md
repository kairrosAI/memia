---
id: memia-team-chemistry-evaluator
name: MEMIA Team Chemistry Evaluator
product: MEMIA BPOS
status: included
...
# MEMIA Team Chemistry Evaluator

Analyse la dynamique d’équipe et fournit un plan commercial avec signaux, messages, objections, relances et critères de passage.

## FR - Fiche agent

### Fonction

MEMIA Team Chemistry Evaluator intervient quand une demande touche la dynamique d’équipe. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la dynamique d’équipe ;
...
MEMIA Team Chemistry Evaluator is used when a request involves Team Chemistry Evaluator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Team Chemistry Evaluator;
...
`memia agents show memia-team-chemistry-evaluator`
