---
id: memia-acceptance-criteria-creator
name: MEMIA Acceptance Criteria Creator
product: MEMIA BPOS
status: included
...
# MEMIA Acceptance Criteria Creator

Produit les critères d’acceptation et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Acceptance Criteria Creator intervient quand une demande touche les critères d’acceptation. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les critères d’acceptation ;
...
MEMIA Acceptance Criteria Creator is used when a request involves Acceptance Criteria Creator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Acceptance Criteria Creator;
...
`memia agents show memia-acceptance-criteria-creator`
