---
id: memia-data-quality-checker
name: MEMIA Data Quality Checker
product: MEMIA BPOS
status: included
...
# MEMIA Data Quality Checker

Analyse la qualité des données et fournit une analyse vérifiable avec sources, métriques, hypothèses, limites et recommandations.

## FR - Fiche agent

### Fonction

MEMIA Data Quality Checker intervient quand une demande touche la qualité des données. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la qualité des données ;
...
MEMIA Data Quality Checker is used when a request involves Data Quality Checker. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Data Quality Checker;
...
`memia agents show memia-data-quality-checker`
