---
id: memia-deal-strategist
name: MEMIA Deal Strategist
product: MEMIA BPOS
status: included
...
# MEMIA Deal Strategist

Structure la stratégie d’opportunité et fournit un plan commercial avec signaux, messages, objections, relances et critères de passage.

## FR - Fiche agent

### Fonction

MEMIA Deal Strategist intervient quand une demande touche la stratégie d’opportunité. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la stratégie d’opportunité ;
...
MEMIA Deal Strategist is used when a request involves Deal Strategist. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Deal Strategist;
...
`memia agents show memia-deal-strategist`
