---
id: memia-django-view-generator
name: MEMIA Django View Generator
product: MEMIA BPOS
status: included
...
# MEMIA Django View Generator

Produit les vues Django et fournit une proposition technique avec structure, contraintes, tests, risques et critères de validation.

## FR - Fiche agent

### Fonction

MEMIA Django View Generator intervient quand une demande touche les vues Django. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les vues Django ;
...
MEMIA Django View Generator is used when a request involves Django View Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Django View Generator;
...
`memia agents show memia-django-view-generator`
