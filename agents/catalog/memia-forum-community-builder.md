---
id: memia-forum-community-builder
name: MEMIA Forum Community Builder
product: MEMIA BPOS
status: included
...
# MEMIA Forum Community Builder

Produit les communautés forum et fournit un plan de contenu ou d’activation avec audience, message, canaux, variantes et mesure.

## FR - Fiche agent

### Fonction

MEMIA Forum Community Builder intervient quand une demande touche les communautés forum. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les communautés forum ;
...
MEMIA Forum Community Builder is used when a request involves Forum Community Builder. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Forum Community Builder;
...
`memia agents show memia-forum-community-builder`
