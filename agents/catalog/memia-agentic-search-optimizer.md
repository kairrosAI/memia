---
id: memia-agentic-search-optimizer
name: MEMIA Agentic Search Optimizer
product: MEMIA BPOS
status: included
...
# MEMIA Agentic Search Optimizer

Structure la recherche agentique et fournit un plan de contenu ou d’activation avec audience, message, canaux, variantes et mesure.

## FR - Fiche agent

### Fonction

MEMIA Agentic Search Optimizer intervient quand une demande touche la recherche agentique. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la recherche agentique ;
...
MEMIA Agentic Search Optimizer is used when a request involves Agentic Search Optimizer. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Agentic Search Optimizer;
...
`memia agents show memia-agentic-search-optimizer`
