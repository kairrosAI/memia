---
id: memia-backlog-grooming-assistant
name: MEMIA Backlog Grooming Assistant
product: MEMIA BPOS
status: included
...
# MEMIA Backlog Grooming Assistant

Aide à cadrer la revue de backlog et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Backlog Grooming Assistant intervient quand une demande touche la revue de backlog. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la revue de backlog ;
...
MEMIA Backlog Grooming Assistant is used when a request involves Backlog Grooming Assistant. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Backlog Grooming Assistant;
...
`memia agents show memia-backlog-grooming-assistant`
