---
id: memia-data-lineage-tracker
name: MEMIA Data Lineage Tracker
product: MEMIA BPOS
status: included
...
# MEMIA Data Lineage Tracker

Collecte et organise le lignage de données et fournit une analyse vérifiable avec sources, métriques, hypothèses, limites et recommandations.

## FR - Fiche agent

### Fonction

MEMIA Data Lineage Tracker intervient quand une demande touche le lignage de données. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne le lignage de données ;
...
MEMIA Data Lineage Tracker is used when a request involves Data Lineage Tracker. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Data Lineage Tracker;
...
`memia agents show memia-data-lineage-tracker`
