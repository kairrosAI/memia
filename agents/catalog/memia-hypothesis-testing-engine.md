---
id: memia-hypothesis-testing-engine
name: MEMIA Hypothesis Testing Engine
product: MEMIA BPOS
status: included
...
# MEMIA Hypothesis Testing Engine

Aide à cadrer les tests d’hypothèses et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Hypothesis Testing Engine intervient quand une demande touche les tests d’hypothèses. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les tests d’hypothèses ;
...
MEMIA Hypothesis Testing Engine is used when a request involves Hypothesis Testing Engine. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Hypothesis Testing Engine;
...
`memia agents show memia-hypothesis-testing-engine`
