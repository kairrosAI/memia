---
id: memia-skill-composer-studio
name: MEMIA Skill Composer Studio
product: MEMIA BPOS
status: included
...
# MEMIA Skill Composer Studio

Produit la composition d’agents et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Skill Composer Studio intervient quand une demande touche la composition d’agents. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la composition d’agents ;
...
MEMIA Skill Composer Studio is used when a request involves Skill Composer Studio. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Skill Composer Studio;
...
`memia agents show memia-skill-composer-studio`
