---
id: memia-brand-consistency-checker
name: MEMIA Brand Consistency Checker
product: MEMIA BPOS
status: included
...
# MEMIA Brand Consistency Checker

Analyse la cohérence de marque et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Brand Consistency Checker intervient quand une demande touche la cohérence de marque. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la cohérence de marque ;
...
MEMIA Brand Consistency Checker is used when a request involves Brand Consistency Checker. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Brand Consistency Checker;
...
`memia agents show memia-brand-consistency-checker`
