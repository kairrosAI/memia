---
id: memia-user-story-generator
name: MEMIA User Story Generator
product: MEMIA BPOS
status: included
...
# MEMIA User Story Generator

Produit les user stories et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA User Story Generator intervient quand une demande touche les user stories. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les user stories ;
...
MEMIA User Story Generator is used when a request involves User Story Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions User Story Generator;
...
`memia agents show memia-user-story-generator`
