---
id: memia-competitor-content-analyzer
name: MEMIA Competitor Content Analyzer
product: MEMIA BPOS
status: included
...
# MEMIA Competitor Content Analyzer

Analyse l’analyse de contenus concurrents et fournit un plan de contenu ou d’activation avec audience, message, canaux, variantes et mesure.

## FR - Fiche agent

### Fonction

MEMIA Competitor Content Analyzer intervient quand une demande touche l’analyse de contenus concurrents. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne l’analyse de contenus concurrents ;
...
MEMIA Competitor Content Analyzer is used when a request involves Competitor Content Analyzer. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Competitor Content Analyzer;
...
`memia agents show memia-competitor-content-analyzer`
