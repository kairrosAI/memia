---
id: memia-content-creator
name: MEMIA Content Creator
product: MEMIA BPOS
status: included
...
# MEMIA Content Creator

Produit la création de contenu et fournit un plan de contenu ou d’activation avec audience, message, canaux, variantes et mesure.

## FR - Fiche agent

### Fonction

MEMIA Content Creator intervient quand une demande touche la création de contenu. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la création de contenu ;
...
MEMIA Content Creator is used when a request involves Content Creator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Content Creator;
...
`memia agents show memia-content-creator`
