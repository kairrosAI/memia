---
id: memia-market-sizing
name: MEMIA Market Sizing
product: MEMIA BPOS
status: included
...
Aide à cadrer le dimensionnement de marché et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Market Sizing intervient quand une demande touche le dimensionnement de marché. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne le dimensionnement de marché ;
...
MEMIA Market Sizing is used when a request involves Market Sizing. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Market Sizing;
...
`memia agents show memia-market-sizing`
