---
id: memia-before-you-build
name: MEMIA Before You Build
product: MEMIA BPOS
status: included
...
# MEMIA Before You Build

Aide à cadrer le cadrage avant construction et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Before You Build intervient quand une demande touche le cadrage avant construction. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne le cadrage avant construction ;
...
MEMIA Before You Build is used when a request involves Before You Build. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Before You Build;
...
`memia agents show memia-before-you-build`
