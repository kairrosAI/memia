---
id: memia-knowledge-base-builder
name: MEMIA Knowledge Base Builder
product: MEMIA BPOS
status: included
...
# MEMIA Knowledge Base Builder

Produit les bases de connaissance et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Knowledge Base Builder intervient quand une demande touche les bases de connaissance. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les bases de connaissance ;
...
MEMIA Knowledge Base Builder is used when a request involves Knowledge Base Builder. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Knowledge Base Builder;
...
`memia agents show memia-knowledge-base-builder`
