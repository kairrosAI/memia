---
id: memia-executive-summary-creator
name: MEMIA Executive Summary Creator
product: MEMIA BPOS
status: included
...
# MEMIA Executive Summary Creator

Produit les synthèses exécutives et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Executive Summary Creator intervient quand une demande touche les synthèses exécutives. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les synthèses exécutives ;
...
MEMIA Executive Summary Creator is used when a request involves Executive Summary Creator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Executive Summary Creator;
...
`memia agents show memia-executive-summary-creator`
