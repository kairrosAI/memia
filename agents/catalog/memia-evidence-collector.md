---
id: memia-evidence-collector
name: MEMIA Evidence Collector
product: MEMIA BPOS
status: included
...
# MEMIA Evidence Collector

Collecte et organise la collecte de preuves et fournit un contrôle qualité avec preuves, écarts, hypothèses et actions correctives.

## FR - Fiche agent

### Fonction

MEMIA Evidence Collector intervient quand une demande touche la collecte de preuves. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la collecte de preuves ;
...
MEMIA Evidence Collector is used when a request involves Evidence Collector. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Evidence Collector;
...
`memia agents show memia-evidence-collector`
