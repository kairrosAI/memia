---
id: memia-configuration-reference-generator
name: MEMIA Configuration Reference Generator
product: MEMIA BPOS
status: included
...
# MEMIA Configuration Reference Generator

Produit les références de configuration et fournit une documentation claire avec public cible, structure, exemples et maintenance prévue.

## FR - Fiche agent

### Fonction

MEMIA Configuration Reference Generator intervient quand une demande touche les références de configuration. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les références de configuration ;
...
MEMIA Configuration Reference Generator is used when a request involves Configuration Reference Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Configuration Reference Generator;
...
`memia agents show memia-configuration-reference-generator`
