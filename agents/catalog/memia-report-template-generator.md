---
id: memia-report-template-generator
name: MEMIA Report Template Generator
product: MEMIA BPOS
status: included
...
# MEMIA Report Template Generator

Produit les modèles de rapport et fournit une analyse vérifiable avec sources, métriques, hypothèses, limites et recommandations.

## FR - Fiche agent

### Fonction

MEMIA Report Template Generator intervient quand une demande touche les modèles de rapport. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les modèles de rapport ;
...
MEMIA Report Template Generator is used when a request involves Report Template Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Report Template Generator;
...
`memia agents show memia-report-template-generator`
