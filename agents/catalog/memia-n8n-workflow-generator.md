---
id: memia-n8n-workflow-generator
name: MEMIA n8n Workflow Generator
product: MEMIA BPOS
status: included
...
# MEMIA n8n Workflow Generator

Produit les workflows d’automatisation et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA n8n Workflow Generator intervient quand une demande touche les workflows d’automatisation. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les workflows d’automatisation ;
...
MEMIA n8n Workflow Generator is used when a request involves n8n Workflow Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions n8n Workflow Generator;
...
`memia agents show memia-n8n-workflow-generator`
