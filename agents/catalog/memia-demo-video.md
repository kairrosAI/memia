...
Aide à cadrer les vidéos de démonstration et fournit un dossier d’exécution avec contexte technique, options, points de vigilance et suite concrète.

## FR - Fiche agent

### Fonction

MEMIA Demo Video intervient quand une demande touche les vidéos de démonstration. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les vidéos de démonstration ;
...
MEMIA Demo Video is used when a request involves Demo Video. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Demo Video;
...
`memia agents show memia-demo-video`
