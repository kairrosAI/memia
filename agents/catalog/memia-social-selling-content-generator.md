---
id: memia-social-selling-content-generator
name: MEMIA Social Selling Content Generator
product: MEMIA BPOS
status: included
...
# MEMIA Social Selling Content Generator

Produit les contenus de social selling et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Social Selling Content Generator intervient quand une demande touche les contenus de social selling. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les contenus de social selling ;
...
MEMIA Social Selling Content Generator is used when a request involves Social Selling Content Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Social Selling Content Generator;
...
`memia agents show memia-social-selling-content-generator`
