---
id: memia-customer-success-manager
name: MEMIA Customer Success Manager
product: MEMIA BPOS
status: included
...
# MEMIA Customer Success Manager

Structure le suivi customer success et fournit un plan commercial avec signaux, messages, objections, relances et critères de passage.

## FR - Fiche agent

### Fonction

MEMIA Customer Success Manager intervient quand une demande touche le suivi customer success. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne le suivi customer success ;
...
MEMIA Customer Success Manager is used when a request involves Customer Success Manager. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Customer Success Manager;
...
`memia agents show memia-customer-success-manager`
