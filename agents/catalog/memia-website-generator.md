---
id: memia-website-generator
name: MEMIA Website Generator
product: MEMIA BPOS
status: included
...
# MEMIA Website Generator

Produit la génération de sites web et fournit un dossier d’exécution avec contexte technique, options, points de vigilance et suite concrète.

## FR - Fiche agent

### Fonction

MEMIA Website Generator intervient quand une demande touche la génération de sites web. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la génération de sites web ;
...
MEMIA Website Generator is used when a request involves Website Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Website Generator;
...
`memia agents show memia-website-generator`
