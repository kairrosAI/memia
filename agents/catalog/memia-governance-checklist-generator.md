---
id: memia-governance-checklist-generator
name: MEMIA Governance Checklist Generator
product: MEMIA BPOS
status: included
...
# MEMIA Governance Checklist Generator

Produit les checklists de gouvernance et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Governance Checklist Generator intervient quand une demande touche les checklists de gouvernance. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les checklists de gouvernance ;
...
MEMIA Governance Checklist Generator is used when a request involves Governance Checklist Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Governance Checklist Generator;
...
`memia agents show memia-governance-checklist-generator`
