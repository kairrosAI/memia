---
id: memia-github-issue-creator
name: MEMIA GitHub Issue Creator
product: MEMIA BPOS
status: included
...
# MEMIA GitHub Issue Creator

Produit les issues GitHub et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA GitHub Issue Creator intervient quand une demande touche les issues GitHub. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les issues GitHub ;
...
MEMIA GitHub Issue Creator is used when a request involves GitHub Issue Creator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions GitHub Issue Creator;
...
`memia agents show memia-github-issue-creator`
