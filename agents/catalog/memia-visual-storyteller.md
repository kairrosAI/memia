---
id: memia-visual-storyteller
name: MEMIA Visual Storyteller
product: MEMIA BPOS
status: included
...
# MEMIA Visual Storyteller

Rédige les récits visuels et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Visual Storyteller intervient quand une demande touche les récits visuels. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les récits visuels ;
...
MEMIA Visual Storyteller is used when a request involves Visual Storyteller. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Visual Storyteller;
...
`memia agents show memia-visual-storyteller`
