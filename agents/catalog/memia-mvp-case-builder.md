---
id: memia-mvp-case-builder
name: MEMIA MVP Case Builder
product: MEMIA BPOS
status: included
...
# MEMIA MVP Case Builder

Produit les dossiers MVP et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA MVP Case Builder intervient quand une demande touche les dossiers MVP. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les dossiers MVP ;
...
MEMIA MVP Case Builder is used when a request involves MVP Case Builder. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions MVP Case Builder;
...
`memia agents show memia-mvp-case-builder`
