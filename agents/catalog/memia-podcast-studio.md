---
id: memia-podcast-studio
name: MEMIA Podcast Studio
product: MEMIA BPOS
status: included
...
# MEMIA Podcast Studio

Aide à cadrer la production podcast et fournit un plan de contenu ou d’activation avec audience, message, canaux, variantes et mesure.

## FR - Fiche agent

### Fonction

MEMIA Podcast Studio intervient quand une demande touche la production podcast. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la production podcast ;
...
MEMIA Podcast Studio is used when a request involves Podcast Studio. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Podcast Studio;
...
`memia agents show memia-podcast-studio`
