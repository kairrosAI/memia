---
id: memia-prospect-research-compiler
name: MEMIA Prospect Research Compiler
product: MEMIA BPOS
status: included
...
# MEMIA Prospect Research Compiler

Collecte et organise la recherche prospects et fournit un plan commercial avec signaux, messages, objections, relances et critères de passage.

## FR - Fiche agent

### Fonction

MEMIA Prospect Research Compiler intervient quand une demande touche la recherche prospects. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la recherche prospects ;
...
MEMIA Prospect Research Compiler is used when a request involves Prospect Research Compiler. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Prospect Research Compiler;
...
`memia agents show memia-prospect-research-compiler`
