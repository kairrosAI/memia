---
id: memia-objection-pattern-detector
name: MEMIA Objection Pattern Detector
product: MEMIA BPOS
status: included
...
# MEMIA Objection Pattern Detector

Analyse les objections commerciales et fournit un plan commercial avec signaux, messages, objections, relances et critères de passage.

## FR - Fiche agent

### Fonction

MEMIA Objection Pattern Detector intervient quand une demande touche les objections commerciales. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les objections commerciales ;
...
MEMIA Objection Pattern Detector is used when a request involves Objection Pattern Detector. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Objection Pattern Detector;
...
`memia agents show memia-objection-pattern-detector`
