---
id: memia-meeting-prep
name: MEMIA Meeting Prep
product: MEMIA BPOS
status: included
...
Aide à cadrer la préparation de réunion et fournit une synthèse actionnable avec priorités, arbitrages, risques et prochaines actions.

## FR - Fiche agent

### Fonction

MEMIA Meeting Prep intervient quand une demande touche la préparation de réunion. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la préparation de réunion ;
...
MEMIA Meeting Prep is used when a request involves Meeting Prep. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Meeting Prep;
...
`memia agents show memia-meeting-prep`
