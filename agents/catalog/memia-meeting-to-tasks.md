---
id: memia-meeting-to-tasks
name: MEMIA Meeting to Tasks
product: MEMIA BPOS
status: included
...
# MEMIA Meeting to Tasks

Aide à cadrer la transformation des réunions en actions et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Meeting to Tasks intervient quand une demande touche la transformation des réunions en actions. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la transformation des réunions en actions ;
...
MEMIA Meeting to Tasks is used when a request involves Meeting to Tasks. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Meeting to Tasks;
...
`memia agents show memia-meeting-to-tasks`
