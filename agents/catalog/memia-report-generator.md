---
id: memia-report-generator
name: MEMIA Report Generator
product: MEMIA BPOS
status: included
...
# MEMIA Report Generator

Produit les rapports structurés et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Report Generator intervient quand une demande touche les rapports structurés. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les rapports structurés ;
...
MEMIA Report Generator is used when a request involves Report Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Report Generator;
...
`memia agents show memia-report-generator`
