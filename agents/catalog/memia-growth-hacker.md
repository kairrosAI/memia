---
id: memia-growth-hacker
name: MEMIA Growth Hacker
product: MEMIA BPOS
status: included
...
Aide à cadrer la croissance et fournit un plan de contenu ou d’activation avec audience, message, canaux, variantes et mesure.

## FR - Fiche agent

### Fonction

MEMIA Growth Hacker intervient quand une demande touche la croissance. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la croissance ;
...
MEMIA Growth Hacker is used when a request involves Growth Hacker. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Growth Hacker;
...
`memia agents show memia-growth-hacker`
