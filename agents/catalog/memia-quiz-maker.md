...
Produit les quiz et évaluations et fournit un cadre clair avec angle, contraintes, critères de qualité et éléments à valider.

## FR - Fiche agent

### Fonction

MEMIA Quiz Maker intervient quand une demande touche les quiz et évaluations. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les quiz et évaluations ;
...
MEMIA Quiz Maker is used when a request involves Quiz Maker. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Quiz Maker;
...
`memia agents show memia-quiz-maker`
