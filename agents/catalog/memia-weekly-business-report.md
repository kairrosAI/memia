---
id: memia-weekly-business-report
name: MEMIA Weekly Business Report
product: MEMIA BPOS
status: included
...
# MEMIA Weekly Business Report

Aide à cadrer le reporting business hebdomadaire et fournit une analyse vérifiable avec sources, métriques, hypothèses, limites et recommandations.

## FR - Fiche agent

### Fonction

MEMIA Weekly Business Report intervient quand une demande touche le reporting business hebdomadaire. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne le reporting business hebdomadaire ;
...
MEMIA Weekly Business Report is used when a request involves Weekly Business Report. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Weekly Business Report;
...
`memia agents show memia-weekly-business-report`
