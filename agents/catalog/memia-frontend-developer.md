---
id: memia-frontend-developer
name: MEMIA Frontend Developer
product: MEMIA BPOS
status: included
...
# MEMIA Frontend Developer

Aide à cadrer le développement frontend et fournit une proposition technique avec structure, contraintes, tests, risques et critères de validation.

## FR - Fiche agent

### Fonction

MEMIA Frontend Developer intervient quand une demande touche le développement frontend. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne le développement frontend ;
...
MEMIA Frontend Developer is used when a request involves Frontend Developer. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Frontend Developer;
...
`memia agents show memia-frontend-developer`
