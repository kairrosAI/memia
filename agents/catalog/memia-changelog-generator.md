---
id: memia-changelog-generator
name: MEMIA Changelog Generator
product: MEMIA BPOS
status: included
...
# MEMIA Changelog Generator

Produit les changelogs et fournit une documentation claire avec public cible, structure, exemples et maintenance prévue.

## FR - Fiche agent

### Fonction

MEMIA Changelog Generator intervient quand une demande touche les changelogs. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les changelogs ;
...
MEMIA Changelog Generator is used when a request involves Changelog Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Changelog Generator;
...
`memia agents show memia-changelog-generator`
