---
id: memia-short-video-strategy-planner
name: MEMIA Short Video Strategy Planner
product: MEMIA BPOS
status: included
...
# MEMIA Short Video Strategy Planner

Structure la stratégie vidéo courte et fournit un plan de contenu ou d’activation avec audience, message, canaux, variantes et mesure.

## FR - Fiche agent

### Fonction

MEMIA Short Video Strategy Planner intervient quand une demande touche la stratégie vidéo courte. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne la stratégie vidéo courte ;
...
MEMIA Short Video Strategy Planner is used when a request involves Short Video Strategy Planner. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Short Video Strategy Planner;
...
`memia agents show memia-short-video-strategy-planner`
