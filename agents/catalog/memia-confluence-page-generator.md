---
id: memia-confluence-page-generator
name: MEMIA Confluence Page Generator
product: MEMIA BPOS
status: included
...
# MEMIA Confluence Page Generator

Produit les pages de connaissance et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Confluence Page Generator intervient quand une demande touche les pages de connaissance. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les pages de connaissance ;
...
MEMIA Confluence Page Generator is used when a request involves Confluence Page Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Confluence Page Generator;
...
`memia agents show memia-confluence-page-generator`
