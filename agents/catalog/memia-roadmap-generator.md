---
id: memia-roadmap-generator
name: MEMIA Roadmap Generator
product: MEMIA BPOS
status: included
...
# MEMIA Roadmap Generator

Produit les feuilles de route et fournit une fiche exploitable avec objectifs, contexte, points ouverts, décisions à prendre et prochaines étapes.

## FR - Fiche agent

### Fonction

MEMIA Roadmap Generator intervient quand une demande touche les feuilles de route. Il transforme une intention, un contexte ou un signal de surface en résultat clair : ce qui est vrai, ce qui reste à vérifier, ce qu’il faut décider et ce qui doit être fait ensuite.

### Quand l’utiliser

- une demande utilisateur mentionne les feuilles de route ;
...
MEMIA Roadmap Generator is used when a request involves Roadmap Generator. It turns an intent, context or surface signal into a clear result: what is known, what must be checked, what should be decided and what should happen next.

### Use it when

- a user request mentions Roadmap Generator;
...
`memia agents show memia-roadmap-generator`
